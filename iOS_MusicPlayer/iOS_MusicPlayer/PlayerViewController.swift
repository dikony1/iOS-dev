...
class PlayerViewController: UIViewController {
    ...
    func configure() {
        ...
        do{
            ...
            guard let urlString =  urlString as NSString? else {
                print("urlString is nil")
                return
            }
            
            player = try AVAudioPlayer(contentsOf: URL(string:urlString as String)!)
        ...
        //labels: song name. album and artist
